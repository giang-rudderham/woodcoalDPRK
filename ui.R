                   ...
                   tabPanel("Map of DPRK",
                            div(class = "outer",
                                ...
                                absolutePanel(id = "controls", class = "panel panel-default",
                                              ...
                                              strong("Select to display visualizations of wood and coal usage for cooking and/or heating."),
                                              checkboxInput("cooking", 
                                                            "Percentage of households that use wood and coal as cooking fuel",
                                                            value = FALSE),
                                              checkboxInput("heating",
                                                            "Percentage of households that use wood and coal for heating",
                                                            value = TRUE),
